...
(
	...
	CONSTRAINT CHK_SA_Component_PROCESS CHECK (DBO.FUN_PROCESS_EXISTS(Process_ID)=CAST(1 AS BIT)),
	CONSTRAINT CHK_SA_Component_SAIDVAR CHECK (DBO.FUN_SAIDVAR_EXISTS(SA_ID,VAR_Type,IsVariable)=CAST(1 AS BIT)),
